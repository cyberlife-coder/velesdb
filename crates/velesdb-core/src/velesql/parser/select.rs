...
impl Parser {
    ...
    // NOTE: MATCH parsing functions (parse_match_query, parse_graph_pattern, parse_node_pattern,
    // parse_node_properties, parse_property_value, parse_relationship_pattern, parse_rel_spec_inner,
    // parse_rel_range, parse_return_clause, parse_return_expr) moved to match_parser.rs
    // (EPIC-061/US-002 refactoring - reduced file from 1068 to ~800 lines)
