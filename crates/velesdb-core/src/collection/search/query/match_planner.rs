...
impl MatchQueryPlanner {
    ...
    fn count_hops(match_clause: &MatchClause) -> u32 {
    ...
    fn estimate_selectivity(threshold: f32) -> f64 {
...
mod tests {
    use super::*;
    use crate::velesql::{
        CompareOp, GraphPattern, NodePattern, RelationshipPattern, ReturnClause,
        SimilarityCondition, VectorExpr,
    };
